                    ...
                    if (actions != null)
                        foreach (var action in actions)
                        {
                            ...
                            if (attributes != null)
                            {
                                ...
                                if (!menus.Any(m => m.MenuName == authorizedDefinitionAttribute.Menu))
                                {
                                    menu = new() { MenuName = authorizedDefinitionAttribute.Menu };
                                    menus.Add(menu);
                                }
                                else
                                    menu = menus.FirstOrDefault(m => m.MenuName == authorizedDefinitionAttribute.Menu);
